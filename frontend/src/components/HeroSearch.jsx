...
export default function HeroSearch({ onSubmit, defaultQuery = '', disabled }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        position: 'absolute', right: 50, bottom: -20, width: 140, height: 140,
      ...
      <div style={{ marginBottom: 14, position: 'relative' }}>
        <span style={{
          ...
          <span style={{ animation: 'pulse-dot 2s ease infinite' }}>✦</span>
      ...
      <div style={{
        ...
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#8896a7" strokeWidth="2" style={{ flexShrink: 0, marginRight: 10 }}>
